...
| **Story ID** | **Título**                                     |
|--------------|------------------------------------------------|
| TS-13        | Configurar Entorno de Desarrollo               |
| TS-14        | Solucionar Errores Reportados                  |
| TS-15        | Implementar Notificaciones como Funcionalidad  |
| TS-16        | Registrar Usuarios por una API                 |
| TS-17        | Autenticación de Usuarios                      |
| TS-18        | Subida de Reportes                             |
| TS-19        | Implementar Funcionalidad de Exportar Reportes |
| TS-20        | Mantenimiento del Software                     |
...
| 13         | TS-13             | Configurar Entorno de Desarrollo               | Como desarrollador, quiero configurar mi entorno de desarrollo local para poder trabajar en el proyecto.                                                          | 3                |
| 14         | TS-14             | Solucionar Errores Reportados                  | Como desarrollador, quiero corregir los errores del software notificados por el equipo de QA para mejorar la calidad del producto.                                | 5                |
| 15         | TS-15             | Implementar Notificaciones como Funcionalidad  | Como desarrollador, quiero implementar el poder recibir notificaciones para mantener al usuario informado sobre sus reportes.                                     | 5                |
| 16         | TS-16             | Registrar Usuarios por una API                 | Como desarrollador, quiero implementar una API que permita registrar nuevos usuarios al sistema.                                                                  | 3                |
| 17         | TS-17             | Autenticación de Usuarios                      | Como desarrollador, quiero implementar una API que permita autenticar a los usuarios en el sistema.                                                               | 3                |
| 18         | TS-18             | Subida de Reportes                             | Como desarrollador, quiero implementar la funcionalidad mediante API que permita a los usuarios subir su reporte para ser analizado por el sistema.               | 5                |
| 19         | TS-19             | Implementar Funcionalidad de Exportar Reportes | Como desarrollador, quiero implementar la funcionalidad mediante API de exportar reportes en formato PDF o Excel para que los usuarios puedan analizar sus datos. | 5                |
| 20         | TS-20             | Mantenimiento del Software                     | Como desarrollador, quiero mantener actualizado y en buen estado el software para asegurar su correcto funcionamiento y seguridad.                                | 3                |
